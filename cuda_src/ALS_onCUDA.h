...
__global__ void updateW_overH_kernel(long rows, const long* row_ptr, const unsigned* col_idx, const unsigned* colMajored_sparse_idx, const float* val, float lambda, unsigned k, float* W, float* H);
